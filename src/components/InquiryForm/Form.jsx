                ...
                <div className=' col-md-12 popup'>
                    ...
                    <form className='spcform'>
                        ...
                        <div className="mb-3  w-75">
                            <input type="tel" className="form-control border-0" placeholder="Mobile Number" />
                        </div>
                        ...
                        <div className='d-flex justify-content-center'>
                            <button type="submit" className="btn px-5 py-0 rounded-pill border-3 border-white text-white fw-semibold">Submit</button>
                        </div>
